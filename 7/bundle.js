...
/* harmony import */ var _src_view_no_films_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../src/view/no-films.js */ "./src/view/no-films.js");
/* harmony import */ var _mocks_film_card_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./mocks/film-card.js */ "./src/mocks/film-card.js");
/* harmony import */ var _mocks_filter_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./mocks/filter.js */ "./src/mocks/filter.js");
...
const films = new Array(_utils_const_js__WEBPACK_IMPORTED_MODULE_0__["CARDS_NUMBER"]).fill(``).map(_mocks_film_card_js__WEBPACK_IMPORTED_MODULE_14__["generateFilm"]);
const filters = Object(_mocks_filter_js__WEBPACK_IMPORTED_MODULE_15__["generateFilter"])(films);

const siteHeader = document.querySelector(`.header`);
const siteMainElement = document.querySelector(`.main`);
const siteFooter = document.querySelector(`.footer`);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(siteHeader, new _src_view_user_status_js__WEBPACK_IMPORTED_MODULE_2__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(siteMainElement, new _src_view_main_site_menu_js__WEBPACK_IMPORTED_MODULE_3__["default"](filters), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(siteMainElement, new _src_view_main_sorting_filter_js__WEBPACK_IMPORTED_MODULE_4__["default"](filters), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(siteFooter, new _src_view_footer_js__WEBPACK_IMPORTED_MODULE_11__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(siteMainElement, new _src_view_main_films_section_js__WEBPACK_IMPORTED_MODULE_5__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);

const siteMainFilms = siteMainElement.querySelector(`.films`);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(siteMainFilms, new _src_view_films_list_js__WEBPACK_IMPORTED_MODULE_6__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);

const filmsList = siteMainFilms.querySelector(`.films-list`);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(filmsList, new _src_view_films_list_container_js__WEBPACK_IMPORTED_MODULE_7__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
...
const renderFilm = (filmListElement, film) => {
  ...
  const onEscKeyDown = (evt) => {
    if (evt.key === `Escape` || evt.key === `Esc`) {
      evt.preventDefault();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["remove"])(filmDetailsComponent);
  ...
  filmComponent.setOpenClickHandler(() => {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(siteMainElement, filmDetailsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
  ...
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(filmListElement, filmComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
};
...
if (films.length === 0) {
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(filmsList, new _src_view_no_films_js__WEBPACK_IMPORTED_MODULE_13__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
}
...
if (films.length > _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FILM_COUNT_PER_STEP"]) {
  ...
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(filmsList, showMoreButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
  ...
  showMoreButtonComponent.setClickHandler(() => {
    ...
    if (renderedFilmCount >= films.length) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["remove"])(showMoreButtonComponent);
    }
  });
}

if (films.length > 0) {
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(siteMainFilms, new _src_view_films_list_extra_js__WEBPACK_IMPORTED_MODULE_10__["default"](_utils_const_js__WEBPACK_IMPORTED_MODULE_0__["EXTRAS_NAMES"][0]), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(siteMainFilms, new _src_view_films_list_extra_js__WEBPACK_IMPORTED_MODULE_10__["default"](_utils_const_js__WEBPACK_IMPORTED_MODULE_0__["EXTRAS_NAMES"][1]), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
  const filmsListsExtra = siteMainFilms.querySelectorAll(`.films-list--extra`);

  for (const filmsListExtra of filmsListsExtra) {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_16__["render"])(filmsListExtra, new _src_view_films_list_container_js__WEBPACK_IMPORTED_MODULE_7__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_16__["RenderPosition"].BEFOREEND);
...
/*!****************************!*\
  !*** ./src/utils/utils.js ***!
  \****************************/
/*! exports provided: getRandomInteger, getRandomIndex, getRandomElem, getRandomArray, getBoolean, getRandomName, getRandomDescription, getRunTime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
